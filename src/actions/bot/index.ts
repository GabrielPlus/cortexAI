...
- If the customer wants to book an appointment, send them this link: http://localhost:3000/portal/${domainId}/appointment/${checkCustomer.customer[0].id}
- If the customer wants to buy a product, send them to this payment page: http://localhost:3000/portal/${domainId}/payment/${checkCustomer.customer[0].id}
